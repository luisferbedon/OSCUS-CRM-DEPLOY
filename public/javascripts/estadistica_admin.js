...
operacion: "contactos", id_grupo: id_grupo
	...
	$.post(databaseUrl,{ operacion:"procesados",seler:seler_name}).done(function(data){
		...
		$.post(databaseUrl,{ operacion:"aceptados_admin",oficina:id_grupo}).done(function(data2){
		obj2 = $.parseJSON(data2);
		aceptados = obj2.length;
		$.post(databaseUrl,{ operacion:"rechazados_admin",oficina:id_grupo}).done(function(data3){
